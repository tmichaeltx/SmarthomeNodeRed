...
var app1 = new Vue({
    ...
    methods: {
        increment: function(event) {
            ...
            var topic = this.msgRecvd.topic || 'placeholder topic of "uibuilder/vue" when not topic has been recieved'
            //! sendig the message built using info inside this Vue instance
            uibuilder.send( {
                'topic': topic,
                'payload': {
                    'type': 'counterBtn',
